...
function postCreate():Void {
	...
	splashSkinDropdown.onChange = (index:Int) -> {
		for (i => strum in previewStrumLine.members) {
			...
			splash.scale.set(scale * 0.55, scale * 0.55);
		}
	}
	...
	var closeButton:UIButton = new UIButton(saveButton.x - 20 - saveButton.bWidth, saveButton.y, /* creatingStrumLine ? 'Cancel' : */ 'Close', () -> close(), 125);
